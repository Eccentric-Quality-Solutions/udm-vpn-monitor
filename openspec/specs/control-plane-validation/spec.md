...
Controller-side acceptance of deploy, observe-only posture, mode control, config pull/push, log centralization, and fleet status using Bash `manage/` tools — without a long-lived management server.
