...
log_resource_monitoring_summary_if_due() {
	...
	if summary_interval_is_due "$current_time" "$last_time" "$summary_interval_seconds"; then
		...
		atomic_write_state_file_or_warn "$cpu_success_file" "0"
		atomic_write_state_file_or_warn "$cpu_fail_file" "0"
		atomic_write_state_file_or_warn "$ram_success_file" "0"
		atomic_write_state_file_or_warn "$ram_fail_file" "0"
		atomic_write_state_file_or_warn "$disk_success_file" "0"
		atomic_write_state_file_or_warn "$disk_fail_file" "0"
		atomic_write_state_file_or_warn "$cpu_constrained_file" "0"
		atomic_write_state_file_or_warn "$ram_constrained_file" "0"
		atomic_write_state_file_or_warn "$disk_critical_file" "0"
