...
@test "check_resource_constrained validates usage is 0-100" {
	...
	if ! command -v log_message >/dev/null 2>&1; then
		# Log message (test helper stub)
		#
		# Test helper stub function when logging.sh cannot be sourced.
		# No-op implementation for testing.
		#
		# Arguments:
		#   $1: Log level (ignored in stub)
		#   $2: Location name (ignored in stub)
		#   $3: Message (ignored in stub)
		#
		# Returns:
		#   0: Always succeeds
		#
		# Note:
		#   This is a test helper stub. The real implementation is in logging.sh.
		log_message() {
			: # No-op for testing
		}
	fi
